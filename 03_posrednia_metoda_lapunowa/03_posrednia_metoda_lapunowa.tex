...
\textbf{Stabilność w sensie Lapunowa - krok po kroku}
\begin{enumerate}
    \item Punkt równowagi $x_e$ nazywamy \textbf{stabilnym} w sensie Lapunowa, jeżeli dla każdej kuli o wymyślonym przez nas promieniu $\epsilon$
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.3\linewidth]{fig/StabilnoscLapunowaTS2Krok1.pdf}
    \end{figure}
    \item można znaleźć kulę o promieniu $\delta_{\epsilon}$
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.3\linewidth]{fig/StabilnoscLapunowaTS2Krok2.pdf}
    \end{figure}
    \item aby każda trajektoria fazowa układu rozpoczynająca się w jakimkolwiek punkcie $x_0$ leżącym w kuli o promieniu $\delta_{\epsilon}$
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.3\linewidth]{fig/StabilnoscLapunowaTS2Krok3.pdf}
    \end{figure} 
    \item pozostała wewnątrz kuli o promieniu $\epsilon$ dla dowolnej chwili $t_0\geq 0$
    \begin{figure}[H]
    \centering
...
\textbf{Definicja 6}
Punkt równowagi $x_{e}$ układu (\ref{eq:sys}) nazywamy jednostajnie stabilnym, jeśli $\delta_{\epsilon}$ z definicji 4 jest niezależne od czasu początkowego $t_{0}$.
...
\textbf{Definicja 9}
Zbiór wszystkich takich punktów $x_{0}$ w przestrzeni stanów, dla których $\lim_{t\rightarrow\infty}\lVert x_{e} - x(t;t_{0},x_{0}) \rVert = 0$ dla pewnego $t_{0} \geq 0$ nazywamy zbiorem przyciągania (obszarem atrakcji) punktu równowagi $x_{e}$.
...
\begin{tcolorbox}[colback=green!5, colframe=green!75!black, title=Przykład]
    ...
    $$
        ...
        \right\},
    $$
    posiadający jededny punkt równowagi w początku układu współrzędnych,
    ...
    $$
    Zatem funkcja Lapunowa nie jest radialnie ograniczona, a tym samym nie możemy
    ...
    \begin{figure}[H]
        ...
        zbiór poziomicowy dla $V(x) = 1$ jest nieodomknięty.}
    \end{figure}
\end{tcolorbox}
...
może się z niej „wylać”, a udowodniona zostanie co najwyżej stabilność lokalną
wewnątrz tej "miski".
\end{tcolorbox}
...
systemoddala się od punktu równowagi.
...
\end{tcolorbox}
    ...
    \subsection{Przykłady}
        ...
        \begin{enumerate}
            ...
            Zbiór ten został przedstawiony na rysunku (\ref{fig:przyklad_4_obszar_3}).
            \begin{figure}[H]
                \centering
        ...
        \begin{enumerate}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=0.7\linewidth]{fig/przyklad_5_obszar_2.png}
                \caption{Portret fazowy układu (\ref{eq:example_5_sys}) z obszarem atrakcji wynikającym z funkcji Lapunowa}
    ...
    mogą zarażać osoby podatne, oraz pewne szane ozdrowienia (ale nie nabierania
    odporności).
    ...
    \end{itemize}
    Model ten ma nieskończenie wele punktów równowagi, położonych na dwóch
    prostych:
    \begin{itemize}
    ...
    \begin{figure}[H]
        ...
        \label{fig:si_pf}
    \end{figure}
    Mozna zauważyć, że w przeciwieństwie do przykładu poprzedniego zaznaczone
    odcinki nie są zbioram przyciągania/odpychania a zbiorem punktów równowagi -
    jeśli trajektoria wląduje na zielonym odcinku to nie będzie się po nim
    poruszać, pozostanie w punkcie, w którym się znalazła.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
