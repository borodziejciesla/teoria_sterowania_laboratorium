...
\begin{tcolorbox}[colback=green!5, colframe=green!75!black, title=Przykład]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{fig/03_lapunow/radialna_nieograniczonosc.eps}
...
\end{tcolorbox}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.25\linewidth]{fig/03_lapunow/snipping_ACC_Case.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\linewidth]{fig/03_lapunow/acc_pp.eps}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\linewidth]{fig/03_lapunow/si_v_vp.eps}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\linewidth]{fig/03_lapunow/si_pf.eps}
