...
\begin{tcolorbox}[colback=green!5, colframe=green!75!black, title=Przykład]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.65\linewidth]{fig/02_metody_czestotliwosciowe/zasada_argumentu_1.png}
...
\begin{tcolorbox}[colback=green!5, colframe=green!75!black, title=Przykład]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.65\linewidth]{fig/02_metody_czestotliwosciowe/zasada_argumentu_2.png}
...
\begin{tcolorbox}[colback=green!5, colframe=green!75!black, title=Przykład]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.65\linewidth]{fig/02_metody_czestotliwosciowe/zasada_argumentu_3.png}
...
\begin{tcolorbox}[colback=green!5, colframe=green!75!black, title=Przykład]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.65\linewidth]{fig/02_metody_czestotliwosciowe/zasada_argumentu_4.png}
...
\begin{tcolorbox}[colback=green!5, colframe=green!75!black, title=Przykład]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.65\linewidth]{fig/02_metody_czestotliwosciowe/zasada_argumentu_transmitancja.png}
