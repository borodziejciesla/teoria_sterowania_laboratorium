...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{fig/zasada_argumentu_kontur.PNG}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{fig/zasada_argumentu_kontur_C_K.PNG}
...
\begin{tcolorbox}[colback=green!5, colframe=green!75!black, title=Przykład]
    $F(s) = s -1$ - jeden pierwiastek w konturze
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.65\linewidth]{fig/zasada_argumentu_1.png}
        \caption{Zasada argumentu dla funkcji $F(s) = s-1$ i konturu zdefiniowanego jako okrąg o promieniu 2 i środkiem w punkcie (0,0).}
    \end{figure}
\end{tcolorbox}

\begin{tcolorbox}[colback=green!5, colframe=green!75!black, title=Przykład]
    $F(s) = (s-1)(s-1.55)$  - dwa pierwiastki w konturze
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.65\linewidth]{fig/zasada_argumentu_2.png}
...
\begin{tcolorbox}[colback=green!5, colframe=green!75!black, title=Przykład]
    $F(s) = (s-1)(s-1.55)$  - jeden pierwiastek w konturze
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.65\linewidth]{fig/zasada_argumentu_3.png}
...
\begin{tcolorbox}[colback=green!5, colframe=green!75!black, title=Przykład]
    $F(s) = (s-1)(s-1.55)$  - brak pierwiastków w konturze
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.65\linewidth]{fig/zasada_argumentu_4.png}
...
\begin{tcolorbox}[colback=green!5, colframe=green!75!black, title=Przykład]
    $F(s) = \frac{(s-1)(s-0.5)}{(s-2)(s+0.5)(s+1)(s+0.75)}$  - dwa pierwiastki i cztery bieguny w konturze
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.65\linewidth]{fig/zasada_argumentu_transmitancja.png}
...
\begin{tcolorbox}[colback=pink!5, colframe=pink!75!black, title=Intuicja]
    Rozważmy funkcję najczęściej wystepującą w teorii sterowania - transmitancję
    $G(s)$, która jest funkcją wymierną, czyli ilorazem dwóch wielomianów
    rzeczywistych zmiennej zespolonej $s$:
    $$
        G(s) = \frac{L(s)}{M(s)} = \frac{\prod_{i=1}^{m}(s-z_i)}{\prod_{j=1}^{n}(s-b_j)}.
    $$
    Podstawmy $s = e^{i\omega}$, gdzie $\omega \in [0,2\pi]$, czyli punkt $s$
    opisuje okrąg jednostkowy w kierunku dodatnim.
    \newline
    Każdy czynnik licznika ma postać $s-z_i$. Gdy $s$ obiega okrąg, wektor
    $s-z_i$  wykonuje jedno pełne dodatnie obrócenie wokół zera (jeśli $z_i$
    jest wewnątrz konturu). To daje zmianę argumentu $+2\pi$.
    \newline
    Każdy czynnik mianownika ma postać $s-b_j$. Gdy $s$ obiega okrąg, wektor
    $s-b_j$ wykonuje jedno pełne dodatnie obrócenie wokół bieguna (jeśli
    $b_j$ jest wewnątrz konturu). To daje zmianę argumentu $-2\pi$ - ponieważ
    jest w~mianowniku.
    \newline
    Dlatego całkowita zmiana argumentu wynosi
    $2\pi(Z_f - B_f)$, czyli zera dodają obroty, a~bieguny je odejmują.
\end{tcolorbox}
...
%            \label{tab:my_label}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.75\linewidth]{fig/michajlow_przyklad_1.PNG}
...
%            \label{tab:my_label}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.5\linewidth]{fig/michajlow_przyklad_2.PNG}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.75\linewidth]{fig/nyquist_otwarty_zamkniety.PNG}
    ...
    \begin{enumerate}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1.0\linewidth]{fig/nyquist_stabilny_przeciecia.PNG}
            \caption{Ilustracja kryterium Nyquista dla stabilnego $G_{0}(s)$.}
        \end{figure}
        \begin{figure}[H]
            \centering
            \includegraphics[width=1.0\linewidth]{fig/nyquist_niestabilny_przeciecia.PNG}
            \caption{Ilustracja kryterium Nyquista dla niestabilnego $G_{0}(s)$
            - dwa pierwiastki niestabilne.}
        \end{figure}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.35\linewidth]{fig/nyquist_astatyzm_kontur.png}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.75\linewidth]{fig/nyquist_astatyczny.png}
    ...
    czyli z pierwiastkami na osi urojonej, ale różnymi od 0. Dowód można znaleźć np. w \cite{Grabowski2022}.
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1.0\linewidth]{fig/nyquist_stabilny.png}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1.0\linewidth]{fig/bode_stabilny.png}
            \caption{Charakterystyka Bodego dla układu z przykładu 3.}
        \end{figure}

        Innym użytecznym typem wykresu jest tak zwany plot Nicholsa (ten sam
        Nichols co od metody Zieglera-Nicholsa). Przedstawia on fazę i magnitudę na jednym wykresie.
        Aby system był stabilny po zamknięciu pętli sprzężenia zwrotnego, plot ten musi okrążać punkt $(-180, 0)$ z prawej strony.
        \begin{figure}[H]
            \centering
            \includegraphics[width=1.0\linewidth]{fig/nichols_stabilny.png}
            \caption{Charakterystyka Nicholsa dla układu z przykładu 3.}
        \end{figure}

        \begin{tcolorbox}[colback=green!5, colframe=green!75!black, title=Przykład]
            Rozpatrzmy transmitancję:
            $$
                G(s) = \frac{0.01 * (s^2 + \frac{1}{10}s+4)}{s(9s^5 + \frac{23}{10}s^4 + \frac{101}{10}s^3 + \frac{7}{10}s^2 + 1)}
            $$
            Ploty Nyquista oraz Bodego są dla tej transmitancji dość
            skomplikowane (wiele zapętleń, dopełnienie w nieskończoności,
            szeroki zakres amplitud nie ułatwia sprawy) i~trudno jest szybko
            wyznaczyć zapas fazy oraz amplitudy.

            \begin{figure}[H]
            \begin{subfigure}{0.45\linewidth}
                \begin{center}
                \includegraphics[width=1.0\linewidth]{fig/hard_nyquist}
                \caption{} 
            ...
            \begin{subfigure}{0.45\linewidth}
                \begin{center}
                \includegraphics[width=1.0\linewidth]{fig/hard_bode}
                \caption{} 
                \label{fig:bicycle_distances}
                \end{center}
            \end{subfigure}
            \caption{(a) Plot Nyquista (b) Plot Bodego.}
            \end{figure}
            Jeśli natomiast wyrysujemy plot Nicholsa, to wyznaczenie tego zapasu
            jest niemal natychmiastowe:
            \begin{figure}[H]
                \centering
                \includegraphics[width=0.5\linewidth]{fig/hard-nichols}
                \caption{Plot Nicholsa dla przykładu.}
            \end{figure}
        \end{tcolorbox}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1.0\linewidth]{fig/nyquist_1.png}
            \caption{Charakterystyka Nyquista dla układu z przykładu 3.}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1.0\linewidth]{fig/bode_1.png}
            \caption{Charakterystyka Bodego dla układu z przykładu 3.}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.75\linewidth]{fig/nichols_1.png}
            \caption{Charakterystyka Nicholsa dla układu z przykładu 3.}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1.0\linewidth]{fig/nyquist_2.png}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1.0\linewidth]{fig/bode_2.png}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1.0\linewidth]{fig/nichols_2.png}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1.0\linewidth]{fig/nyquist_6.png}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1.0\linewidth]{fig/nichols_6.png}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1.0\linewidth]{fig/nyquist_7.png}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1.0\linewidth]{fig/nichols_7.png}
