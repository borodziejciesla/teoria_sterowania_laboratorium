...
\section{Wprowadzenie}
    ...
    \subsection{Definicje}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.5\linewidth]{fig/lurie_bloki.PNG}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.35\linewidth]{fig/funkcja_sektorowa.PNG}
        ...
        \begin{itemize}
            \item $G(s) = \frac{1}{s} \rightarrow G(i\omega) = -\frac{i}{\omega}$ - jest PR (nie jest SPR) - cała charakterystyka leży na osi urojonych - rysunek (\ref{fig:spr_i}),
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=0.5\linewidth]{fig/spr_i.PNG}
            ...
            \item $G(s) = \frac{1}{s+\alpha} \rightarrow G(i\omega) = \frac{\alpha}{\omega^2 + \alpha^2} - i\frac{\omega}{\omega^2 + \alpha^2}$, gdzie $\alpha > 0$ - jest SPR - rysunek (\ref{fig:spr_ii}),
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=0.5\linewidth]{fig/spr_ii.PNG}
            ...
            \item $G(s) = \frac{1}{s^2 + 2s + 1} \rightarrow G(i\omega) = -\frac{\omega^2 - 1}{(\omega^2 - 1)^2 + 4\omega^{2}} - i\frac{2\omega}{(\omega^2 - 1)^2 + 4\omega^{2}}$ - nie jest PR ani SPR - rysunek (\ref{fig:spr_iii}),
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=0.5\linewidth]{fig/spr_iii.PNG}
            ...
            + i \frac{\left(w^2-1\right)\,\left(3\,w-w^3\right) - w\,\left(3\,w^2-1\right)}{{\left(3\,w-w^3\right)}^2+{\left(3\,w^2-1\right)}^2}$ - jest SPR - rysunek (\ref{fig:spr_iiii}).
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=0.5\linewidth]{fig/spr_iiii.PNG}
        ...
        $$
        Jest ona ściśle ujemnie określona, zatem zerowy punkt równowagi $x_{e} = 0$ jest globalnie asymptotycznie stabilny.
        ...
        \begin{itemize}
            \item wszystkie pierwiastki $\lambda_{i}$ równania charakterystycznego transmitancji spełniają warunek $Re\left\{\lambda_{i}\right\} \leq 0$,
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.25\linewidth]{fig/feedback_pasywny.PNG}
    ...
    \begin{itemize}[(a)]
        \item macierz $A$ jest hurwitzowska (tzn. wszystkie wartości własne macierzy leżą w lewej półpłaszczyźnie zespolonej) oraz para $(A, b)$ jest sterowalna,
        ...
        \end{equation}
        dla dowolnie małego $\epsilon > 0$
    \end{itemize}
    to zerowy punkt równowagi $x_{e} = 0$ jest \textit{globalnie asymptotycznie stabilny}.

    \begin{figure}[H]
        \centering
        \includegraphics[width=0.25\linewidth]{fig/popov_sektor.PNG}
    ...
    \begin{equation}
        ...
        G_{P}(i\omega) = P(\omega) + i\underbrace{\omega Q(\omega)}_{Q_{P}(\omega)} = P_{P}(\omega) + iQ_{P}(\omega)
    \end{equation}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{fig/popov_interpretacja.PNG}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=1.0\linewidth]{fig/przykladowe.PNG}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.75\linewidth]{fig/popov_szkic.PNG}
    ...
    \begin{description}
      \item[$S_{1}$] \hfill \\
        ...
        \begin{itemize}
            \item pierwiastki równania charakterystycznego $Re\left\{\lambda_{i}\right\} \leq 0$,
      ...
      $$
      gdzie: $g_{2}(\sigma) = \sigma\varphi(\sigma) + \frac{1}{k}\varphi(\sigma)^{2} > 0$ dla $\varphi(\cdot) \in [0, k]$.
    \end{description}
    Zatem $S_{2}$ jest systemem dysypatywnym, układ sterowania jest stabilny, a funkcja Lapunowa, którą można zastosować to:
    $$
        V(x) = x^{T}Px + \alpha\int_{0}^{c^{T}x}{\varphi(\gamma)d\gamma}
    $$

    \begin{tcolorbox}[colback=orange!5, colframe=orange!75!black, title=Uwaga]
        Nierówność Popova, podobnie jak kryterium Lapunowa, jest warunkiem
        wystarczającym, ale nie jest warunkiem koniecznym stabilności układu Lurie.
        Oznacza to, że istnieją układy Lurie, które są stabilne, ale nie spełniają nierówności Popova.
    \end{tcolorbox}
    ...
    \begin{itemize}
        ...
        \item istnieje $k_{0} \in [k_{1},k_{2}]$, takie że $Re\left\{ \lambda_i(A-bk_{0}c^{T}) \right\} < 0$,
    ...
    %    \begin{figure}[H]
    %        \centering
    %        \includegraphics[width=0.75\linewidth]{fig/intuicja_kolo_1.PNG}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.75\linewidth]{fig/intuicja_kolo_2.PNG}
    ...
    \begin{tcolorbox}[colback=pink!5, colframe=pink!75!black, title=Intuicja]
        W klasycznym kryterium Nyquista dla układów liniowych z regulatorem
        proporcjonalnym $K$, kluczowym punktem na płaszczyźnie zespolonej jest
        $(-\frac{1}{K},j0)$. To wokół niego badamy liczbę okrążeń charakterystyki
        częstotliwościowej $G(j\omega)$, aby określić stabilność układu
        zamkniętego.
        Wyobraźmy sobie teraz ewolucję tego kryterium, gdy wprowadzamy
        niepewność wartości regulatora, czyli gdy $K$ może przyjmować wartości
        w~pewnym zakresie $[K_1, K_2]$. Wówczas:
        \begin{itemize}
            \item niepewność powoduje "wędrowanie" punktu $(-\frac{1}{K},j0)$
            na prostej pomiędzy $(-\frac{1}{K_1},j0)$ a $(-\frac{1}{K_2},j0)$,
            \item dodatkowo ponieważ $K$ może zmieniać wartość w dowolnej
            chwili, odcinek ten "puchnie" do koła,
            \item aby uwzględnić wszystkie możliwe kombinacje i zapewnić stabilność, musimy badać liczbę okrążeń wokół takiego koła.
        \end{itemize}

        W rezultacie, kryterium koła jest naturalnym rozszerzeniem kryterium
        Nyquista, które uwzględnia niepewność w regulatorze i~zapewnia
        stabilność
        układu zamkniętego dla wszystkich wartości regulatora w określonym
        zakresie.
    \end{tcolorbox}

    \begin{tcolorbox}[colback=orange!5, colframe=orange!75!black, title=Uwaga]
        Kryterium koła jest bardziej ogólne niż kryterium Popova, ponieważ pozwala na niestacjonarność funkcji nieliniowej $\varphi(y,t)$ oraz rozszerza zakres funkcji nieliniowych do sektora $[k_{1}, k_{2}]$.
         Jednakże, kryterium koła jest również bardziej restrykcyjne w porównaniu do kryterium Popova, ponieważ wymaga spełnienia dodatkowych warunków dotyczących macierzy stanu $A$ oraz istnienia $k_{0}$, dla którego $Re\left\{ \lambda_i(A-bk_{0}c^{T}) \right\} < 0$.
    \end{tcolorbox}

    \begin{tcolorbox}[colback=orange!5, colframe=orange!75!black, title=Uwaga]
        Również kryterium koła, podobnie jak kryterium Popova, jest warunkiem wystarczającym, ale nie jest warunkiem koniecznym stabilności układu Lurie.
        Oznacza to, że istnieją układy Lurie, które są stabilne, ale nie spełniają nierówności kryterium koła.
    \end{tcolorbox}
    ...
    %\begin{figure}[H]
    %    \centering
    %    \includegraphics[width=0.25\linewidth]{fig/nasycenie.PNG}
...
\section{Przykłady}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.75\linewidth]{fig/przyklad_1_a.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.75\linewidth]{fig/przyklad_1_b.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{fig/przyklad_2_uklad.PNG}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.75\linewidth]{fig/przyklad_2_charakterystyka.PNG}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{fig/przyklad_3.PNG}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.75\linewidth]{fig/przyklad_3_charakterystyka.PNG}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{fig/przyklad_4_uklad.PNG}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.75\linewidth]{fig/przyklad_4_charakterystyka.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{fig/przyklad_5_uklad.PNG}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{fig/przyklad_5_uklad_modyfikacja.PNG}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{fig/przyklad_5_uklad_virtualny.PNG}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{fig/przyklad_5_charakterystyka.PNG}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.75\linewidth]{fig/przyklad_6_kolo.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{fig/przyklad_7_charakterystyka.PNG}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{fig/przyklad_7_charakterystyka2.PNG}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.75\linewidth]{fig/przyklad_8_uklad.PNG}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.75\linewidth]{fig/przyklad_8_charakterystyka.PNG}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{fig/przyklad_9_uklad.PNG}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.25\linewidth]{fig/przyklad_9_stozek.PNG}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{fig/przyklad_9_obszar.PNG}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{fig/przyklad_10_uklad.PNG}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{fig/przyklad_10_obszar.PNG}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{fig/przyklad_11_uklad.PNG}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{fig/przyklad_11_obszar.PNG}
